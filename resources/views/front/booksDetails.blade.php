...
@section('content')
    ...
    <div class="container">
        ...
        <nav class="my-5" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('books')}}">الكتب</a></li>
    ...
    <section class="articles mb-5">
        <div class="title">
            <div class="container">
                <h5><span class="py-1">:كتب ذات صلة</span> </h5>
            </div>
        </div>
                    ...
                    <div class="slick-cont">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center"><a href="{{route('details-books',$book->id)}}" class="btn bg px-5">التفاصيل</a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
