...
@section('content')
    ...
    <section class="articles py-5">
        <div class="title">
            <div class="container">
                <h2><span class="py-1">الكتب</span> </h2>
            </div>
            <hr />
        </div>
                    ...
                    <div class="slick-cont">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center"><a href="{{route('details-books',$book->id)}}" class="btn bg px-5">التفاصيل</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="blood-app py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h4 class="mt-5 mb-4">تطبيق المكتبة</h4>
                    <p class="appText">المكتبه الدوليه للكتب تساعدنا علي معرفه الكتب في المكتبه وعمل استعاره عن طريق الانترنت</p>
                ...
                <div class="col-md-6 my-3"><img src="{{asset('assests/front/imgs/bookstore.jpg')}}" class="img-fluid" alt=""></div>
            </div>
            <!--End row-->
        </div>
        <!--End container-->
